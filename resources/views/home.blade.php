...
@section('content')
    ...
    <section class="desktop-show primary-section mt-18rem">
        <div class="container">
            <div class="row mb-5">
                <div class="col-xs-12 col-sm-6 col-md-8 col-lg-8 pl-0">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4" id="sidebars">
                    ...
                    <div class="row mx-0 mt-3">
                        <div class="col-sm-4 col-md-4 col-lg-5 pr-sm-0">
                            <img src="{{asset('public/evamedia/artikel-img/foto-cover/')}}" class="d-block w-100 mt-1rem side-img" alt="Uko">
                        </div>
                        <div class="col-sm-8 col-md-8 col-md-7 px-0">
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-12 ">
                                    <ul class="list-date-article list-inline">
                                        <li class="list-inline-item">
                                            <a href="{{ url('evamedia/') }}">
                                                <span class="text-kategori list-article-text">Lifestyle</span>
                                            </a>
                                        </li>
                                        <li class="list-date list-bullet-article list-inline-item">
                                            <span class="color-date date--artikel list-article-text">12/10/2023</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-sm-12 col-md-12 col-lg-12">
                                    <a href="{{ url('evamedia-detail/') }}">
    ...
    <!-- MOBILE -->
    <section class="mobile-show primary-section mt-4rem">
        <div class="">
            <div class="row mx-0">
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 px-0 col-m">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 mt-5 px-0" id="sidebars">
                    ...
                    <div class="row mx-0 mt-3">
                        <div class="col-xs-4 col-sm-4 col-md-5 col-lg-5 pr-sm-0">
                            <img src="{{asset('public/evamedia/artikel-img/foto-cover/')}}" class="d-block w-100 mt-1rem mt-xs-05 side-img" alt="Nope">
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <ul class="list-date-article list-inline">
                                        ...
                                        <li class="list-date list-bullet-article list-inline-item">
                                            <span class="color-date date--artikel list-article-text">12/11/3044</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        /*  function load_data(id="",dates_data="",times_data="", _token)
         {
          $.ajax({
           ...
           success:function(data)
           {
            ...
            $('#post_data_mobile').append(data.output_mobile);
           }
          })
         }
         ...
         function load_data_all_kategori(id="",dates_data="",times_data="",kategori="",tipe="", _token)
         {
          $.ajax({
           ...
           success:function(data)
           {
            ...
            $('#loads_kategori_mobile_'+kategori).remove();
            $('#post_data_'+kategori).append(data.output);
            $('#post_data_mobile_'+kategori).append(data.output_mobile);
           }
          })
         } */
         ...
         $(document).on('click', '#load_more_button_kat', function(){
            var id = $(this).attr('data-loadid');
            var date = $(this).attr('data-loaddate');
            var time = $(this).attr('data-loadtime');
            var kat = $(this).attr('data-loadkat');
            $(this).html('<b>Loading...</b>');
            load_data_all_kategori(id,date,time,kat,'lanjut', _token);
         });
